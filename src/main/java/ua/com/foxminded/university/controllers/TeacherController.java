...
public class TeacherController {
    ...
    public String newTeacher(Model model) {
        model.addAttribute("teacher", new ua.com.foxminded.university.entities.person.Teacher());
    ...
    @PostMapping
    public String create(@ModelAttribute("teacher") ua.com.foxminded.university.entities.person.Teacher teacher,
